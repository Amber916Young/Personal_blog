...
public class Config {
	...
	protected static final String LOGIN_URL = "https://api.youku.com/oauth2/token";
	protected static final String CREATE_URL = "https://api.youku.com/uploads/create.json";
	...
	protected static final String COMMIT_URL = "https://api.youku.com/uploads/commit.json";
	protected static final String CANCEL_URL = "https://api.youku.com/uploads/cancel.json";
	protected static final String VERSION_UPADATE_URL = "https://api.youku.com/sdk/version_update";

	protected static final String CATEGORY = "upload";
	protected static final String TYPE = "java";
	protected static final String VERSION = "20200526";
	// 检查各分片状态，然后重置
